...
public class PatientCustomRepository {
    ...
    public List<Patient> findAllByFilters(String name, String bloodType, String gender, String postalCode) {
        ...
        if (bloodType != null && !bloodType.isEmpty()) {
            predicates.add(cb.equal(patient.get("tpBlood"), bloodType));
        }

        if (gender != null && !gender.isEmpty()) {
            predicates.add(cb.equal(patient.get("tpSex"), gender));
        }
